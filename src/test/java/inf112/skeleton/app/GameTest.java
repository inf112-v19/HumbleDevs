...
public class GameTest {
    ...
    public void testTrackLaser(){
        ArrayList<Object> rob = game.trackLaser(Direction.EAST, new Position(0,2));
        assertEquals(rob.get(1),robs[0]);
        Wall wall = new Wall(Direction.WEST);
        board.insertItem(5,5,wall);
        ArrayList<Object> wallHit = game.trackLaser(Direction.EAST,new Position(0,5));
        assertEquals(wall,wallHit.get(1));
        ArrayList<Object> miss = game.trackLaser(Direction.NORTH,new Position(0,5));
        assertNull(miss.get(1));
    }
    ...
    public void testLaser(){
        ...
        game.activatePassiveItems();
        assertEquals(6,rob.getDamageTokens());
    }
    @Test
